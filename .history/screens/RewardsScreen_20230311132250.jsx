import { Alert, ScrollView, KeyboardAvoidingView, StyleSheet, Text, TextInput, Pressable, View, Dimensions } from 'react-native'
...
// Amlipfy Auth
  ...
  const [password, setPassword] = useState(dbUser?.password || "");
  ...
  const createUser = async () => {
    try {
      const user = await DataStore.save(new User({email, password, sub})
      );
      setDbUser(user)
     } catch (e) {
