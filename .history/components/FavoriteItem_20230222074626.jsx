   ...
   {/* <Pressable onPress={onPress} style={styles.productDetails}> */}
      ...
      <View style={{flex: 1, flexDirection: 'row', marginHorizontal: 10, marginVertical: 0}}>
        <View style={{flex: 1, flexDirection: 'column', justifyContent: "center", alignItems: 'center', marginHorizontal: 20}}>
            ...
            />
        <View>
            <Text style={styles.itemText}>{favorite.flavor}</Text>
            <Text style={styles.ratingText}>Rating {favorite.avgRating} /5</Text>
         ...
         <View style={styles.ratingsContainer}>
          ...
          {/* <Text>{item.avgRating}</Text> */}
            ...
            <Text style={styles.caloriesText}>{favorite.calories} Cal</Text>
            <Text style={styles.caloriesText}>{favorite.price}</Text>
        </View>
    </View>
    </View>
    {/* </Pressable> */}
