      ...
      <View style={{flex: 1, flexDirection: 'row', marginHorizontal: 10, marginVertical: 0}}>
        <View style={{flex: 1, flexDirection: 'column', justifyContent: "center", alignItems: 'center', marginHorizontal: 20}}>
            <Image 
                ...
                source={{uri: donuts.image }} 
            />
        <View>
            <Text style={styles.itemText}>{donuts.flavor}</Text>
            <Text style={styles.ratingText}>Rating {donuts.avgRating} /5</Text>
         ...
         <View style={styles.ratingsContainer}>
          ...
          {/* <Text>{item.avgRating}</Text> */}
            ...
            <Text style={styles.caloriesText}>{donuts.calories} Cal</Text>
        </View>
    </View>
    </View>
    {/* </Pressable> */}
